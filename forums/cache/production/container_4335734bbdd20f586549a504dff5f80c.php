...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005bc774e00000000034ff4bf7(
...
class phpbbtemplatetwiglexer_000000005bc774e00000000034ff4bf7 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59a461bba293c754476579 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59a461bba2944075918074 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59a461bba291f390173004 = array(
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, 'set_environment', array('env' => $env), $this->initializer59a461bba2944075918074);

        return $this->valueHolder59a461bba293c754476579->set_environment($env);
    }
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59a461bba2944075918074);

        return $this->valueHolder59a461bba293c754476579->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59a461bba2944075918074);

        return $this->valueHolder59a461bba293c754476579->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59a461bba2944075918074 = $initializer;
    }
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, '__get', array('name' => $name), $this->initializer59a461bba2944075918074);

        if (isset(self::$publicProperties59a461bba291f390173004[$name])) {
            return $this->valueHolder59a461bba293c754476579->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59a461bba293c754476579;
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59a461bba2944075918074);
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, '__isset', array('name' => $name), $this->initializer59a461bba2944075918074);
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, '__unset', array('name' => $name), $this->initializer59a461bba2944075918074);
    ...
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, '__clone', array(), $this->initializer59a461bba2944075918074);

        $this->valueHolder59a461bba293c754476579 = clone $this->valueHolder59a461bba293c754476579;
    }

    public function __sleep()
    {
        $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, '__sleep', array(), $this->initializer59a461bba2944075918074);

        return array('valueHolder59a461bba293c754476579');
    }
    ...
    {
        return $this->initializer59a461bba2944075918074;
    }
    ...
    {
        return $this->initializer59a461bba2944075918074 && $this->initializer59a461bba2944075918074->__invoke($this->valueHolder59a461bba293c754476579, $this, 'initializeProxy', array(), $this->initializer59a461bba2944075918074);
    }
    ...
    {
        return null !== $this->valueHolder59a461bba293c754476579;
    }
    ...
    {
        return $this->valueHolder59a461bba293c754476579;
    }
