...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003879516a000000006067f627(
...
class phpbbtemplatetwiglexer_000000003879516a000000006067f627 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59a4617f5d660621885135 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59a4617f5d669963975272 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59a4617f5d645743244551 = array(
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, 'set_environment', array('env' => $env), $this->initializer59a4617f5d669963975272);

        return $this->valueHolder59a4617f5d660621885135->set_environment($env);
    }
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59a4617f5d669963975272);

        return $this->valueHolder59a4617f5d660621885135->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59a4617f5d669963975272);

        return $this->valueHolder59a4617f5d660621885135->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59a4617f5d669963975272 = $initializer;
    }
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, '__get', array('name' => $name), $this->initializer59a4617f5d669963975272);

        if (isset(self::$publicProperties59a4617f5d645743244551[$name])) {
            return $this->valueHolder59a4617f5d660621885135->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59a4617f5d660621885135;
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59a4617f5d669963975272);
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, '__isset', array('name' => $name), $this->initializer59a4617f5d669963975272);
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, '__unset', array('name' => $name), $this->initializer59a4617f5d669963975272);
    ...
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, '__clone', array(), $this->initializer59a4617f5d669963975272);

        $this->valueHolder59a4617f5d660621885135 = clone $this->valueHolder59a4617f5d660621885135;
    }

    public function __sleep()
    {
        $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, '__sleep', array(), $this->initializer59a4617f5d669963975272);

        return array('valueHolder59a4617f5d660621885135');
    }
    ...
    {
        return $this->initializer59a4617f5d669963975272;
    }
    ...
    {
        return $this->initializer59a4617f5d669963975272 && $this->initializer59a4617f5d669963975272->__invoke($this->valueHolder59a4617f5d660621885135, $this, 'initializeProxy', array(), $this->initializer59a4617f5d669963975272);
    }
    ...
    {
        return null !== $this->valueHolder59a4617f5d660621885135;
    }
    ...
    {
        return $this->valueHolder59a4617f5d660621885135;
    }
